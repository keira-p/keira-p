...
- 👩‍⚕️ **Smart Stethoscope** - [Live App](https://smart-stethoscope.streamlit.app/) | [Code](https://github.com/mi-mi-mia/smart-stethoscope) - *Team Project*: API and audio classification (CNN + XGBoost)
...
- 🐦 **BeakSpeak** - [Live App]("https://beakspeak-309693526010.europe-west2.run.app/") | [Code]("https://github.com/keira-p/beakspeak") - Fine-grained image classification
- 🧠 **Content Intelligence** - [Code]("https://github.com/keira-p/content-intelligence-system") | A content scoring system that helps brands decide what to promote (**WORK IN PROGRESS**)
